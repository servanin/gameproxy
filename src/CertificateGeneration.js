...
class CertificateGeneration {
    ...
    static generateNewCAandHost(hostCertCN,validDomainsArray) {
        ...
        */
        let hostCert = CertificateGeneration.CreateHostCert(hostCertCN, validDomainsArray, CA);
        return {CA: CA,hostCert:hostCert}
    }
}


module.exports = CertificateGeneration